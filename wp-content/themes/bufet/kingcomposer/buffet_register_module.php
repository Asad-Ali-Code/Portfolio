...
<div class="registration-module register-page">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                    ...
                    <?php
            			global $user_ID, $user_identity;
            				...
            				if (!$user_ID) {
                                ...
                                $redirect_url = esc_url( $_SERVER['REQUEST_URI'] ) . '?register=true';
            	    ?>

                    <div class="card-header">
                        <h3 class="mb-0"><?php esc_html_e('REGISTER', 'bufet'); ?></h3>
                    </div>
                    <div class="card-body">

                    <form class="form" role="form" autocomplete="off" action="<?php echo site_url('wp-login.php?action=register', 'login_post') ?>" method="post">
                        <div class="form-group">
                            <label for="inputName"><?php echo esc_attr( $username_label ); ?></label>
                            <input type="text" class="form-control" id="inputName" name="user_login" value="<?php echo esc_attr(stripslashes($user_login)); ?>" placeholder="<?php echo esc_attr( $username_placeholder ); ?>" required="">
                        </div>
                        <div class="form-group">
                            <label for="inputEmail3"><?php echo esc_attr( $email_label ); ?></label>
                            <input type="email" class="form-control" id="inputEmail3" name="user_email" value="<?php echo esc_attr(stripslashes($user_email)); ?>"  placeholder="<?php echo esc_attr( $email_placeholder ); ?>" required="">
                        </div>
                        ...
                        <div class="form-group">
        					...
        					<?php if($register == true) {
        						echo '<p class="registration_mail_sent">'. esc_html__('Check your email for the password!', 'bufet') .'</p>';
        					} ?>
