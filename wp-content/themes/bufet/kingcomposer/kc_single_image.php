...
$css_classes[] = 'wow';
$css_classes[] = esc_attr( $animation_name );
...
?>
<div <?php echo implode( ' ', $element_attributes ) ;?> data-wow-delay="<?php echo esc_attr( $animation_delay ); ?>">

    <?php
    if( !empty($on_click_action) ) {
    ?>
    <a <?php echo esc_attr($data_lightbox) ;?> href="<?php echo esc_attr( $image_full );?>" title="<?php echo strip_tags( $title_link ) ;?>" target="<?php echo esc_attr( $target );?>">
        <img <?php echo implode( ' ', $image_attributes ) ;?> /><?php echo esc_html( $html );?>
    </a>
    <?php
    } else {
    ?>
