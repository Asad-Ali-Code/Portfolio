            ...
            <div class="card card-outline-secondary">
			    ...
			    ?>
                    ...
                    <div class="card-header">
                        <h3 class="mb-0"><?php esc_html_e('Login', 'bufet'); ?></h3>
                    </div>
                    <div class="card-body">

                    <form class="form" role="form" autocomplete="off" action="<?php echo esc_url( home_url('/') ) ?>wp-login.php" method="post">
                        ...
                        <div class="form-group">
                            <label for="inputEmail3"><?php echo esc_attr( $pass_label ); ?></label>
                            <input type="password" class="form-control" id="inputEmail3"  name="pwd" value="" placeholder="<?php echo esc_attr( $pass_placeholder ); ?>" required="">
                        </div>
                        ...
                        <div class="form-group">
							...
							<div class="align-center">
								<a href="#" class="forget-password"><?php esc_html_e('Forget Password ?', 'bufet') ?></a>
							</div>
                        </div>
                    </form>
